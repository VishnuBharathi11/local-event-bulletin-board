...
function buildDescriptionPrompt(event) {
  ...
  const task = event.description
    ? 'Improve the supplied existing description while preserving every supported fact. Do not silently add any fact. Make the result meaningfully more informative and attendee-oriented.'
