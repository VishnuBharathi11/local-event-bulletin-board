      ...
      <div className={event.imageUrl ? 'event-details__layout event-details__layout--with-image' : 'event-details__layout'}>
        ...
        <div className="event-details__main">
          ...
          <div className="event-details__facts" aria-label="Event information">
            ...
            <div className="event-detail-fact">
              <svg className="event-detail-fact__icon" aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
              <div>
