    ...
    <div className="create-step-content" role="region" aria-labelledby="request-step3-title">
      ...
      <div className="create-step-form">
          ...
          <div className="location-autocomplete" ref={fieldRef}>
            <div className="location-autocomplete__input-wrap">
              <input
                ...
                aria-controls="request-location-suggestions"
                aria-activedescendant={
                  activeSuggestionIndex >= 0
                    ? `request-location-suggestion-${activeSuggestionIndex}`
                    : undefined
                }
              />
            ...
            {suggestionsOpen && suggestions.length > 0 && (
              <div id="request-location-suggestions" className="location-autocomplete__menu" role="listbox">
                {suggestions.map((suggestion, index) => (
                  <button
                    key={`${suggestion.venue}-${suggestion.address}-${index}`}
                    id={`request-location-suggestion-${index}`}
                    type="button"
                    role="option"
        ...
        <div className="form-group" style={{ marginTop: '12px' }}>
          <label>Select on Map <span className="required-star">*</span></label>
          <EventMapPicker
